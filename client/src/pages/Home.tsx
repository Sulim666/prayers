...
import { getLocationByCoordinates, getPopularLocations, searchLocations } from "../lib/api";
...
export default function Home() {
  ...
  useEffect(() => {
    const fetchDefaultLocation = async () => {
      try {
        const response = await apiRequest('GET', `/api/geo/ip-location?language=${language}`, undefined);
